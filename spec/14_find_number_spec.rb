...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      it 'returns 7' do
        solution = game_guessing1.make_guess
    ...
    context 'when min is 8 and max is 9' do
      it 'returns 8' do
        solution = game_guessing2.make_guess
        expect(solution).to eq(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      it 'returns 1' do
        solution = game_guessing3.make_guess
    ...
    context 'when min and max both equal 3' do
      it 'returns 3' do
        solution = game_guessing4.make_guess
        expect(solution).to eq(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      subject(:game_end) { described_class.new(0, 9, number_guessing, 5) }
    ...
    context 'when guess and random_number are not equal' do
      let(:number_guessing1) { double('random_number', value: 5)}
      subject(:game_ending) { described_class.new(0, 9, number_guessing1, 3)}
